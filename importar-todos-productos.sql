-- Script para importar TODOS los productos del archivo producto.txt
...
-- 2. Crear productos faltantes del archivo producto.txt
-- (Estos son algunos ejemplos de productos que pueden faltar)
...
VALUES 
    ('BATERIA YTX5LBS MOURA TITAN 150 BIZ', '1476', 'Eléctrico', 4, 50000, 45000, 'Batería de moto YTX5LBS Moura Titan 150 BIZ', 'unidad', true),
    ('BATERIA YTX5LBS RIDERS', '1481', 'Eléctrico', 1, 48000, 43000, 'Batería de moto YTX5LBS Riders', 'unidad', true),
    ('BATERIA YTX7-LBS MAHLI', '1482', 'Eléctrico', 1, 52000, 47000, 'Batería de moto YTX7-LBS Mahli', 'unidad', true),
    ('BATERIA YTX7A-BS MAHLI', '1002325', 'Eléctrico', 3, 55000, 50000, 'Batería de moto YTX7A-BS Mahli', 'unidad', true)
